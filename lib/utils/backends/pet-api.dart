...
class PetApi{
  ...
  static Future<CustomHttpResponse<Map<String, dynamic>>> addPetRequest(id, name, breed, gender) async{
    ...
    var response = await http.post(Uri.parse(Constant.URL_BE +"/pet"), body: data, headers: thisHeader);
